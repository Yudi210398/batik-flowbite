            ...
            <li>
              <Link
                ...
                className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${
                  isActive("/fe-customer") ? "bg-gray-100 dark:bg-gray-400" : ""
                }`}
              >
                <svg
                ...
                <span className="ms-3 ">Data Customer</span>
              </Link>
            </li>
            <li>
              <Link
                href="/fe-batik"
                className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${
                  isActive("/fe-batik") ? "bg-gray-100 dark:bg-gray-400" : ""
                }`}
              >
                <svg
